...
console.log("******** Condtional Test using Strings *********");
console.log(y == "abcd");
console.log(y != "abcd");
...
console.log("******** Condtional Test using Numbers *********");
console.log(z == 23);
console.log(z != 23);
...
console.log("******** Condtional Test using AND & OR *********");
console.log(y == "abcd" && z == 19);
console.log(y == "abcd" || z == 23);
